...
**Status:** 🔨 published [`waveshare_esp32_s3_rlcd_42@v0.8.0`](https://github.com/klin-lang/waveshare_esp32_s3_rlcd_42/releases/tag/v0.8.0) (panel via [`klin_st7305@v0.2.0`](https://github.com/klin-lang/klin_st7305); sensors via [`klin_shtc3@v0.1.0`](https://github.com/klin-lang/klin_shtc3) + [`klin_pcf85063@v0.1.0`](https://github.com/klin-lang/klin_pcf85063); audio ES8311 + ES7210; silicon radio via separate packs; first tag was `@v0.1.0`)  
...
| Where does the code live? | External: [`klin-lang/waveshare_esp32_s3_rlcd_42`](https://github.com/klin-lang/waveshare_esp32_s3_rlcd_42) `@v0.8.0` |
...
| Radio | **Not board API.** Silicon Wi‑Fi / BLE / ESP-NOW → [`esp_wifi`](https://github.com/klin-lang/esp_wifi) [101](101-esp-wifi-idf.md) / [`esp_ble`](https://github.com/klin-lang/esp_ble) [106](106-esp-ble-idf.md) / [`espnow`](https://github.com/klin-lang/espnow) [159](159-esp-now-idf.md) |
...
- README documents silicon radio via separate packs (no `wifi_*` / `ble_*` in this pack)
...
- Board-owned Wi‑Fi / BLE / ESP-NOW API (silicon radio → separate packs)
...
- SPI / ADC / I2C / I2S / delays are **IDF contracts** (board bus); panel bytes are **`klin_st7305`**; sensor protocols are **`klin_shtc3`** / **`klin_pcf85063`**; audio codecs are board-owned register sequences over I2C; radio stacks are **`esp_wifi` / `esp_ble` / `espnow`**.
...
Radio (optional, separate packages):
...
Mirrors: [`patches/waveshare_esp32_s3_rlcd_42-v0.8.0/`](../patches/waveshare_esp32_s3_rlcd_42-v0.8.0/),
...
[`patches/espnow-v0.1.0/`](../patches/espnow-v0.1.0/).

## Links

- Pack: https://github.com/klin-lang/waveshare_esp32_s3_rlcd_42
- Tag: [v0.8.0](https://github.com/klin-lang/waveshare_esp32_s3_rlcd_42/releases/tag/v0.8.0)
...
- BLE: [106](106-esp-ble-idf.md) / https://github.com/klin-lang/esp_ble
- ESP-NOW: [159](159-esp-now-idf.md) / https://github.com/klin-lang/espnow
