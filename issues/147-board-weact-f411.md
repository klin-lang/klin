...
**Out of scope:** USB CDC `Serial`, G-176 / SD (→ [`klin_st7735`](https://github.com/klin-lang/klin_st7735) example), HSE 25 MHz PLL (HSI 16 MHz is enough), a published `weact_f411ce` pin pack (later, if needed).
