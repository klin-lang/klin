...
| [101](101-esp-wifi-idf.md) | ESP Wi‑Fi thin IDF package (`esp_wifi` STA + SoftAP) | ✅ `@v0.2.0` ([repo](https://github.com/klin-lang/esp_wifi)) | 021, 024, 049, 061, 062, 099 |
...
| [104](104-later-tracks-esp-network.md) | Later tracks: ESP network (SoftAP ✅; scan / RMII / sockets…) | 🔨 W1 SoftAP ✅; rest backlog | 101, 102, 062 |
