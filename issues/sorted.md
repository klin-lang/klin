...
| [140](140-gd32v-ble-sdk.md) | `gd32v_ble` GD32VW553 advertise + GATT + central + gattc + jw-bond + UUID16 + passkey + UUID128/multi (GigaDevice AN152, not `machine_*`) | 🔨 advertise+GATT+scan/connect+gattc+jw-bond+uuid16+passkey+uuid128 `@v0.8.0` | 021, 024, 049, 061, 062, 136, 137 |
