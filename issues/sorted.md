...
| [152](152-for-c-post-compound.md) | C-`for` post: `+=` / `-=` | ✅ | 003, 151 |
...
| [137](137-gd32v-wifi-sdk.md) | `gd32v_wifi` GD32VW553 STA + SoftAP + scan + link + static + APSTA + roaming + WPS + EAP-TLS (GigaDevice SDK, not `machine_*`) | 🔨 STA+SoftAP+scan+link+static+APSTA+roaming+WPS+EAP-TLS `@v0.7.0` | 021, 024, 049, 061, 062, 136 |
...
| [156](156-board-lckfb-gd32vw553.md) | Board scaffold LCKFB GD32VW553 / silk `GD32VW553HMQ-EVT` (`klin init lckfb-gd32vw553`, PC13) | 🔨 template | 061, 062, 075, 136, 138, 139 |
| [140](140-gd32v-ble-sdk.md) | `gd32v_ble` GD32VW553 advertise + GATT + central + gattc + jw-bond + UUID16 + passkey + UUID128/multi + privacy + Mesh OnOff + provisioner + Level/vendor + Friend/LPN + interactive OOB + string OOB / friendship params / vendor byte + iBeacon (GigaDevice AN152, not `machine_*`) | 🔨 … + iBeacon patch `@v0.16.0` ([158](158-gd32v-ble-ibeacon.md)); published `@v0.15.0` | 021, 024, 049, 061, 062, 136, 137 |
...
| [157](157-later-tracks-gd32v-coap-ws-ibeacon-mesh-cloud.md) | Later tracks VW553: iBeacon → CoAP → WebSocket → Wi‑Fi Mesh → cloud (Aliyun/AWS/Azure) | 💭 V1 🔨 [158](158-gd32v-ble-ibeacon.md); V2 🔨 [160](160-gd32v-coap-sdk.md); V3 🔨 [161](161-gd32v-websocket-sdk.md); V4 🔨 [162](162-gd32v-wifi-mesh-sdk.md); V5 staged | 062, 105, 137, 140, 143, 144, 146 |
...
| [161](161-gd32v-websocket-sdk.md) | `gd32v_websocket` WebSocket client (`ws://`; text/bin frames) | 🔨 seed `@v0.1.0` ([patches](../patches/gd32v_websocket-v0.1.0/)) | 137, 143, 157 |
| [162](162-gd32v-wifi-mesh-sdk.md) | `gd32v_wifi_mesh` Wi‑Fi Mesh-Smart (self-organize join) | 🔨 seed `@v0.1.0` ([patches](../patches/gd32v_wifi_mesh-v0.1.0/)) | 137, 157 |
...
| [163](163-board-waveshare-esp32-s3-rlcd-42.md) | Board pack Waveshare ESP32-S3-RLCD-4.2 (ST7305 + 18650 + TF + I2C + sensors + audio; radio separate) | 🔨 `@v0.8.0` ([repo](https://github.com/klin-lang/waveshare_esp32_s3_rlcd_42); panel [164](164-klin-st7305.md); `esp_wifi`/`esp_ble`/`espnow`) | 061, 062, 075, 099, 150, 164 |
...
| [105](105-later-tracks-iot.md) | Later tracks: IoT (MQTT / OTA…) | 💭 (VW553 OTA ✅ [145](145-gd32v-ota-sdk.md); MQTT ✅ [146](146-gd32v-mqtt-sdk.md); iBeacon 🔨 [158](158-gd32v-ble-ibeacon.md); CoAP 🔨 [160](160-gd32v-coap-sdk.md); WS 🔨 [161](161-gd32v-websocket-sdk.md); Mesh 🔨 [162](162-gd32v-wifi-mesh-sdk.md); cloud → [157](157-later-tracks-gd32v-coap-ws-ibeacon-mesh-cloud.md); ESP twins open) | 104, 101, 102, 111, 112, 145, 146, 157, 158, 160, 161, 162 |
...
| [159](159-esp-now-idf.md) | ESP-NOW thin IDF package (`espnow` peer/broadcast) | ✅ `@v0.1.0` ([repo](https://github.com/klin-lang/espnow)) | 021, 024, 049, 061, 062, 101 |
...
| [154](154-numeric-cast.md) | Numeric `cast` (int↔int, float↔float, int↔float; explicit, C semantics) | ✅ | 002, 019, 072 |
...
| [125](125-drop-host-json-sqlite.md) | Drop JSON / SQLite; strike map (hidden resize) | ✅ | 050, 051, 060 |
