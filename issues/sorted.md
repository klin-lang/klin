...
| [062](062-targets-esp-rp.md) | MCU targets: ESP32 / RP2040 / RP2350 / STM8 / CH32V / GD32V | 🚧 (RP Pio+Dma+UsbCdc ✅ `@v0.11.0`; ESP C3+S3+STM8+CH32V+GD32V Pin…Adc ✅; **P4 Pin…Adc+Rmt+LP GPIO+regi2c** ✅ `@v0.14.0`; RMII later) | 010 |
...
| [114](114-machine-esp-esp32-p4.md) | `machine_esp` ESP32-P4 Pin…Adc+Rmt (`*_p4`) | ✅ `@v0.8.0`/`@v0.9.0`/`@v0.10.0`/`@v0.11.0`/`@v0.12.0`/`@v0.13.0`/`@v0.14.0` ([repo](https://github.com/klin-lang/machine_esp)) | 061, 062 |
