...
| [143](143-gd32v-sockets-sdk.md) | `gd32v_sockets` GD32VW553 LwIP BSD sockets (TCP/UDP; after `gd32v_wifi` IP) | 🔨 `@v0.1.0` ready ([repo](https://github.com/klin-lang/gd32v_sockets)) | 021, 024, 049, 137 |
| [144](144-gd32v-http-sdk.md) | `gd32v_http` GD32VW553 HTTP(+TLS PEM) client (after IP; no IDF crt bundle) | 🔨 `@v0.1.0` ready ([repo](https://github.com/klin-lang/gd32v_http)) | 021, 024, 049, 137, 143 |
