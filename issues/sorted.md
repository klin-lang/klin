...
| [062](062-targets-esp-rp.md) | MCU targets: ESP32 / RP2040 / RP2350 / STM8 / CH32V / GD32V | 🚧 (RP Pio+Dma+UsbCdc ✅ `@v0.11.0`; ESP C3+S3+STM8+CH32V+GD32V Pin…Adc ✅; **P4** later + RMII) | 010 |
...
| [103](103-later-tracks-ble-usb-camera-lcd.md) | Later tracks: camera / Pico LCD (BLE → [106](106-esp-ble-idf.md); USB OTG → [108](108-esp-usb-idf.md)) | 💭 backlog (one track at a time) | 061, 062, 101, 102, 106, 108 |
...
| [108](108-esp-usb-idf.md) | ESP USB OTG thin IDF package (`esp_usb` TinyUSB device CDC) | ✅ `@v0.1.0` ([repo](https://github.com/klin-lang/esp_usb)) | 021, 024, 049, 061, 062, 103 |
