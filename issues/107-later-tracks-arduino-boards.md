...
|---|---|---|---|---|
| A | **Leonardo** (also Micro / Pro Micro) | **ATmega32U4** | Extend [`machine_avr`](https://github.com/klin-lang/machine_avr) | **Implementation issue:** [142](142-machine-avr-atmega32u4.md). **Closest win.** New pin / port map (32U4 ≠ 328P); Pin…Adc MMIO like 328P. Native **USB device** (CDC/HID) is separate — USB stack or thin `@[link]` later; MVP can be GPIO + UART without HID. Toolchain: existing `avr-gcc`. Flash: `avrdude` (Caterina / DFU). |
