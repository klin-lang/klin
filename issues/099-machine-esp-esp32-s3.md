...
- Freestanding (no IDF)
- Classic ESP32 / C6 — roadmap [062](062-targets-esp-rp.md)
- **ESP32-P4** — own `*_p4` twins ([114](114-machine-esp-esp32-p4.md); Pin…Adc+Rmt+LP GPIO+regi2c+LP UART `@v0.15.0`; not this S3 port); RMII ✅ [102](102-esp-eth-idf.md) `@v0.2.0`
