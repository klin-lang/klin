...
| # | Track | Likely home | Notes |
|---|---|---|---|
| E1 | **RMII internal EMAC** | `esp_eth` | SoCs with on-chip EMAC: classic **ESP32**; prefer **ESP32-P4** (Pin…Spi ✅ `machine_esp@v0.9.0` [114](114-machine-esp-esp32-p4.md); RMII still this `esp_eth` track). PHY e.g. LAN8720 / IP101; pins / PHY args explicit. |
