...
**Status:** 🔨 W1–W3 Wi‑Fi ✅ (`@v0.2.0`…`@v0.4.0`); ETH/shared backlog (one track at a time)  
...
Wi‑Fi queue W1–W3 done. **Next** from this issue: ETH **E1/E2** (hardware) or shared **N2 sockets**.
