...
**Status:** ✅ published `@v0.3.0` (advertise + GATT server + central scan/connect)  
...
| Where does the code live? | External: [`klin-lang/esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.3.0` |
...
- GATT **client** (read/write/subscribe as central)  
...
- Tag: [v0.3.0](https://github.com/klin-lang/esp_ble/releases/tag/v0.3.0)  
