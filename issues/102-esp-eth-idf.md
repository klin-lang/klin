...
**Status:** ✅ published `@v0.1.0` (W5500 SPI)  
...
| Where does the code live? | External: [`klin-lang/esp_eth`](https://github.com/klin-lang/esp_eth) `@v0.1.0` |
...
- Shared: `wait_ip` / `ip_u32` / `log_ip` / `stop`  
