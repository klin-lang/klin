...
9. **BLE** — ✅ [`esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.3.0` (advertise + GATT + scan/connect; not in `machine_esp`) → [106](106-esp-ble-idf.md)  
