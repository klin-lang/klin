...
| ESP32-C3 / **S3**? | **`machine_esp`** — C3 `pin_out`…`adc_out` ✅; S3 twin `*_s3` Pin…Adc+**Rmt** ✅ `@v0.7.0` ([099](099-machine-esp-esp32-s3.md); **no HW DAC** API); board [`waveshare_esp32_s3_pico`](https://github.com/klin-lang/waveshare_esp32_s3_pico) `@v0.3.0` (WS2812 via RMT) → [100](100-board-waveshare-esp32-s3-pico.md); minimal ESP-IDF boot; **Wi‑Fi** → separate [`esp_wifi`](https://github.com/klin-lang/esp_wifi) `@v0.1.0` ([101](101-esp-wifi-idf.md), not in `machine_*`); **ETH** → [`esp_eth`](https://github.com/klin-lang/esp_eth) [102](102-esp-eth-idf.md); freestanding / classic / C6 / **P4** later ([062](062-targets-esp-rp.md)) |
...
7. **Wi‑Fi** — ✅ separate package [`esp_wifi`](https://github.com/klin-lang/esp_wifi) `@v0.1.0` (STA thin IDF; not in `machine_esp`) → [101](101-esp-wifi-idf.md)  
8. No DAC / no PIO API; freestanding / classic ESP32 / C6 / **ESP32-P4** later ([062](062-targets-esp-rp.md); P4 also preferred RMII host for [102](102-esp-eth-idf.md))  
