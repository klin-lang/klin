...
9. **BLE** — ✅ [`esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.1.0` (NimBLE advertise; not in `machine_esp`) → [106](106-esp-ble-idf.md)  
...
- `bluetooth` — Klin: [`esp_ble`](https://github.com/klin-lang/esp_ble) NimBLE advertise → [106](106-esp-ble-idf.md)  
