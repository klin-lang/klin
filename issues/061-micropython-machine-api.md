...
| GD32VW553 (Nuclei N307 + Wi‑Fi 6 / BLE)? | Same **`machine_gd32v`** — Pin…Adc twins `*_vw553` ✅ `@v0.8.0` [117](117-machine-gd32v-gd32vw553.md). Board [`gd32vw553h_eval`](https://github.com/klin-lang/gd32vw553h_eval) `@v0.1.0` [127](127-board-gd32vw553h-eval.md) (`klin init gd32vw553h-eval`). Wi‑Fi → [`gd32v_wifi`](https://github.com/klin-lang/gd32v_wifi) 🔨 STA+SoftAP+scan `@v0.3.0` [126](126-gd32v-wifi-sdk.md) (GigaDevice SDK, not `machine_*`, not `esp_wifi`). BLE → [`gd32v_ble`](https://github.com/klin-lang/gd32v_ble) 🔨 advertise `@v0.1.0` [130](130-gd32v-ble-sdk.md) (AN152, not `esp_ble`). |
