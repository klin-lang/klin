...
7. **Wi‑Fi** — ✅ separate package [`esp_wifi`](https://github.com/klin-lang/esp_wifi) `@v0.2.0` (STA + SoftAP thin IDF; DHCP default + optional static; not in `machine_esp`) → [101](101-esp-wifi-idf.md)  
