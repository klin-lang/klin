...
7. **Wi‑Fi** — ✅ separate package [`esp_wifi`](https://github.com/klin-lang/esp_wifi) `@v0.3.0` (STA + SoftAP + scan thin IDF; DHCP default + optional static; not in `machine_esp`) → [101](101-esp-wifi-idf.md)  
