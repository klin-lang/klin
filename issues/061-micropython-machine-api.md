...
| GD32VW553 (Nuclei N307 + Wi‑Fi 6 / BLE)? | Same **`machine_gd32v`** — Pin+Pwm+Rc+Uart+I2c twins `*_vw553` ✅ `@v0.6.0` [117](117-machine-gd32v-gd32vw553.md). Spi…Adc / radio later, not `machine_*`. |
