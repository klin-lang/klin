...
| GD32VW553 (Nuclei N307 + Wi‑Fi 6 / BLE)? | Same **`machine_gd32v`** — Pin…Adc twins `*_vw553` ✅ `@v0.8.0` [136](136-machine-gd32v-gd32vw553.md). Boards [`gd32vw553h_eval`](https://github.com/klin-lang/gd32vw553h_eval) `@v0.1.0` [138](138-board-gd32vw553h-eval.md) (`klin init gd32vw553h-eval`), [`gd32vw553h_start`](https://github.com/klin-lang/gd32vw553h_start) `@v0.1.0` [139](139-board-gd32vw553h-start.md) (`klin init gd32vw553h-start`). Wi‑Fi → [`gd32v_wifi`](https://github.com/klin-lang/gd32v_wifi) 🔨 STA+SoftAP+scan+link+static+APSTA+roaming `@v0.6.0` [137](137-gd32v-wifi-sdk.md) (GigaDevice SDK, not `machine_*`, not `esp_wifi`). BLE → [`gd32v_ble`](https://github.com/klin-lang/gd32v_ble) 🔨 advertise+GATT+scan/connect+gattc+jw-bond+uuid16+passkey+uuid128/multi+privacy+mesh+prov+level+friend+oob `@v0.14.0` [140](140-gd32v-ble-sdk.md) (AN152, not `esp_ble`). Sockets / HTTP → [`gd32v_sockets`](https://github.com/klin-lang/gd32v_sockets) / [`gd32v_http`](https://github.com/klin-lang/gd32v_http) 🔨 `@v0.1.0` [143](143-gd32v-sockets-sdk.md) / [144](144-gd32v-http-sdk.md) (after IP; not `esp_sockets` / `esp_http`). |
