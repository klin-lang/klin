...
9. **BLE** — ✅ [`esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.6.0` (advertise + GATT server/client + scan/connect + bond + UUID16; not in `machine_esp`) → [106](106-esp-ble-idf.md)  
...
- `bluetooth` — Klin: [`esp_ble`](https://github.com/klin-lang/esp_ble) NimBLE advertise + GATT + scan + bond + UUID16 → [106](106-esp-ble-idf.md)  
