...
[`blink_p4`](https://github.com/klin-lang/machine_esp/tree/main/examples/blink_p4) / [`pwm_p4`](https://github.com/klin-lang/machine_esp/tree/main/examples/pwm_p4) / [`rmt_p4`](https://github.com/klin-lang/machine_esp/tree/main/examples/rmt_p4) (P4 → [114](114-machine-esp-esp32-p4.md)),
...
`machine_esp` `@v0.12.0` (C3 factories; S3 twins + Rmt — [099](099-machine-esp-esp32-s3.md); P4 Pin…Adc+Rmt — [114](114-machine-esp-esp32-p4.md)):
...
6. **ESP32-P4** Pin…Adc+Rmt (`*_p4`) — ✅ `@v0.8.0` / `@v0.9.0` / `@v0.10.0` / `@v0.11.0` / `@v0.12.0` ([114](114-machine-esp-esp32-p4.md); ADC2 ✅)  
