...
| RP2040 / RP2350? | **`machine_rp`** — Pin+Pwm+Rc+Uart+I2c+Spi+Adc ✅ `@v0.6.0` (**no HW DAC**); ([062](062-targets-esp-rp.md)); board [`waveshare_rp2350_lcd_096`](https://github.com/klin-lang/waveshare_rp2350_lcd_096) `@v0.7.0` → [095](095-board-waveshare-rp2350-lcd-096.md) |
