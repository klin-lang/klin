...
`machine_esp` `@v0.14.0` (C3 factories; S3 twins + Rmt — [099](099-machine-esp-esp32-s3.md); P4 Pin…Adc+Rmt+LP GPIO+regi2c — [114](114-machine-esp-esp32-p4.md)):
...
6. **ESP32-P4** Pin…Adc+Rmt (`*_p4`) — ✅ `@v0.8.0` / `@v0.9.0` / `@v0.10.0` / `@v0.11.0` / `@v0.12.0` / `@v0.13.0` / `@v0.14.0` ([114](114-machine-esp-esp32-p4.md); ADC2 ✅; LP GPIO ✅; regi2c ✅)  
...
13. No DAC / no PIO API; P4 eFuse-cal / RMII / freestanding / classic ESP32 / C6 later ([062](062-targets-esp-rp.md); P4 preferred RMII host for [102](102-esp-eth-idf.md))  
