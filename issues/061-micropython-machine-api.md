...
9. **BLE** — ✅ [`esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.7.0` (GATT + scan/client + bond + UUID16 + passkey; not in `machine_esp`) → [106](106-esp-ble-idf.md)  
...
- `bluetooth` — Klin: [`esp_ble`](https://github.com/klin-lang/esp_ble) NimBLE GATT + scan + bond + UUID16 + passkey → [106](106-esp-ble-idf.md)  
