...
**Packages:** [`machine_stm32`](https://github.com/klin-lang/machine_stm32) (`Pin`…`Adc` `@v0.5.0`), [`machine_rp`](https://github.com/klin-lang/machine_rp) (`Pin`…`Adc`+**Pio**+**Dma**+**UsbCdc** `@v0.11.0`), [`machine_esp`](https://github.com/klin-lang/machine_esp) (C3 + **S3** `*_s3` Pin…Adc+**Rmt** + **P4** Pin…Adc+**Rmt**+LP GPIO+regi2c+LP UART `*_p4` `@v0.15.0`; [099](099-machine-esp-esp32-s3.md), [114](114-machine-esp-esp32-p4.md)), [`machine_stm8`](https://github.com/klin-lang/machine_stm8) (`Pin`…`Adc` `@v0.2.0`), [`machine_avr`](https://github.com/klin-lang/machine_avr) (`Pin` 328P+2560+**32U4**; `Pwm`…`Adc` 328P+**32U4** `@v0.3.0`), [`machine_xmega`](https://github.com/klin-lang/machine_xmega) (`Pin`…`Dac` `@v0.2.0`), [`machine_pic16`](https://github.com/klin-lang/machine_pic16) (`Pin`…`Dac` `@v0.2.0`), [`machine_ch32v`](https://github.com/klin-lang/machine_ch32v) (`Pin`…`Adc` `@v0.1.0`; [134](134-machine-ch32v.md)), [`machine_gd32v`](https://github.com/klin-lang/machine_gd32v) (`Pin`…`Adc` `@v0.2.0`; VW553 Pin…Adc `*_vw553` `@v0.8.0`; [135](135-machine-gd32v.md), [136](136-machine-gd32v-gd32vw553.md)), [`gd32v_wifi`](https://github.com/klin-lang/gd32v_wifi) (VW553 STA+SoftAP+scan+link+static+APSTA+roaming+WPS+EAP-TLS `@v0.7.0`; [137](137-gd32v-wifi-sdk.md)), [`gd32vw553h_eval`](https://github.com/klin-lang/gd32vw553h_eval) (EVAL pins `@v0.1.0`; [138](138-board-gd32vw553h-eval.md)), [`gd32vw553h_start`](https://github.com/klin-lang/gd32vw553h_start) (START pins `@v0.1.0`; [139](139-board-gd32vw553h-start.md)), [`gd32v_ble`](https://github.com/klin-lang/gd32v_ble) (VW553 advertise+GATT+scan/connect+gattc+jw-bond+uuid16+passkey+uuid128/multi+privacy+mesh+prov+level+friend+oob+string+friendparams+vndbyte `@v0.15.0`; [140](140-gd32v-ble-sdk.md))
...
| STM32? | **Yes** — [`machine_stm32`](https://github.com/klin-lang/machine_stm32) (`Pin` + `Pwm` + `Rc` + `Uart` + `I2c` + `Spi` + `Adc` `@v0.5.0`; F411/F401-class — **no HW DAC**); board [`nucleo_f411re`](https://github.com/klin-lang/nucleo_f411re) `@v0.1.3` → [096](096-board-nucleo-f411re.md); WeAct Black Pill → `klin init weact-f411` [147](147-board-weact-f411.md) |
...
| megaAVR (Arduino Uno/Mega)? | **`machine_avr`** — Pin ✅ 328P+2560; **Pwm…Adc** ✅ **328P** `@v0.2.0`+; **ATmega32U4** (Leonardo / Micro / Pro Micro) Pin…Adc `*_32u4` ✅ [`@v0.3.0`](https://github.com/klin-lang/machine_avr/releases/tag/v0.3.0) ([142](142-machine-avr-atmega32u4.md); **no DAC**; 2560 bus factories later). Other Arduino SKUs (Uno R4 / Due / Giga / Portenta) → [107](107-later-tracks-arduino-boards.md). |
...
| GD32VF103 (Nuclei RISC-V)? | **`machine_gd32v`** — Pin…Adc ✅ `@v0.2.0` ([135](135-machine-gd32v.md)); **12-bit** ADC |
| GD32VW553 (Nuclei N307 + Wi‑Fi 6 / BLE)? | Same **`machine_gd32v`** — Pin…Adc twins `*_vw553` ✅ `@v0.8.0` [136](136-machine-gd32v-gd32vw553.md). Boards [`gd32vw553h_eval`](https://github.com/klin-lang/gd32vw553h_eval) `@v0.1.0` [138](138-board-gd32vw553h-eval.md) (`klin init gd32vw553h-eval`), [`gd32vw553h_start`](https://github.com/klin-lang/gd32vw553h_start) `@v0.1.0` [139](139-board-gd32vw553h-start.md) (`klin init gd32vw553h-start`). Wi‑Fi → [`gd32v_wifi`](https://github.com/klin-lang/gd32v_wifi) 🔨 STA+SoftAP+scan+link+static+APSTA+roaming+WPS+EAP-TLS `@v0.7.0` [137](137-gd32v-wifi-sdk.md) (GigaDevice SDK, not `machine_*`, not `esp_wifi`). BLE → [`gd32v_ble`](https://github.com/klin-lang/gd32v_ble) 🔨 advertise+GATT+scan/connect+gattc+jw-bond+uuid16+passkey+uuid128/multi+privacy+mesh+prov+level+friend+oob+string+friendparams+vndbyte `@v0.15.0` [140](140-gd32v-ble-sdk.md) (AN152, not `esp_ble`). Sockets / HTTP → [`gd32v_sockets`](https://github.com/klin-lang/gd32v_sockets) / [`gd32v_http`](https://github.com/klin-lang/gd32v_http) ✅ `@v0.1.0` [143](143-gd32v-sockets-sdk.md) / [144](144-gd32v-http-sdk.md) (after IP; not `esp_sockets` / `esp_http`). OTA → [`gd32v_ota`](https://github.com/klin-lang/gd32v_ota) ✅ `@v0.1.0` [145](145-gd32v-ota-sdk.md) (AN260 ping‑pong; not in `machine_*`). MQTT → [`gd32v_mqtt`](https://github.com/klin-lang/gd32v_mqtt) ✅ `@v0.1.0` [146](146-gd32v-mqtt-sdk.md) (client only; QoS0). |
| Other PIC? | Separate ports if/when needed — not one library for all MCUs |
| DAC? | Only where the silicon has it — **yes** on ATxmega (DACB) and PIC16F18855 (DAC1); **not** on F411/F401, RP2040/2350, ESP32-C3/S3/P4 (no `Dac` API), STM8S, megaAVR 328P/2560/**32U4**, CH32V003, GD32VF103. F407-class / classic ESP32 later if needed. |
...
| USB CDC? | RP2350 — **yes** in [`machine_rp`](https://github.com/klin-lang/machine_rp) `@v0.10.0` (`usb_cdc_out_rp2350` poll ACM); board Type-C console → [095](095-board-waveshare-rp2350-lcd-096.md); RP2040 later. ESP USB OTG device CDC — separate [`esp_usb`](https://github.com/klin-lang/esp_usb) `@v0.1.0` TinyUSB → [108](108-esp-usb-idf.md) (not in `machine_esp`). |
...
[`blink_p4`](https://github.com/klin-lang/machine_esp/tree/main/examples/blink_p4) / [`blink_lp_p4`](https://github.com/klin-lang/machine_esp/tree/main/examples/blink_lp_p4) / [`uart_lp_p4`](https://github.com/klin-lang/machine_esp/tree/main/examples/uart_lp_p4) / [`adc_cal_p4`](https://github.com/klin-lang/machine_esp/tree/main/examples/adc_cal_p4) / [`pwm_p4`](https://github.com/klin-lang/machine_esp/tree/main/examples/pwm_p4) / [`rmt_p4`](https://github.com/klin-lang/machine_esp/tree/main/examples/rmt_p4) (P4 → [114](114-machine-esp-esp32-p4.md)),
...
`machine_esp` `@v0.15.0` (C3 factories; S3 twins + Rmt — [099](099-machine-esp-esp32-s3.md); P4 Pin…Adc+Rmt+LP GPIO+regi2c+LP UART — [114](114-machine-esp-esp32-p4.md)):
...
// ESP32-P4:
let led_p4 = machine.pin_out_p4(2)
let lp_p4 = machine.pin_out_lp_p4(3) // LP GPIO3; do not also call pin_out_p4(3)
let pwm_p4 = machine.pwm_out_p4(2, 0, 0, 80000000)
pwm_p4.freq_p4(1000)
let u_p4 = machine.uart_out_p4(0, 17, 18, 80000000, 115200)
let lp_u_p4 = machine.uart_out_lp_p4(14, 15, 20000000, 115200) // UartLp; XTAL_D2
let rmt_p4 = machine.rmt_tx_p4(2, 0, 80000000) // tick = PLL_F80M/8
machine.adc_cal_init_p4() // regi2c DREF; not inside adc_out_p4
let adc_p4 = machine.adc_out_p4(16, 0) // CH0 → GPIO16; read_u12_p4
let adc2_p4 = machine.adc2_out_p4(49, 0) // ADC2 CH0 → GPIO49
```
...
6. **ESP32-P4** Pin…Adc+Rmt (`*_p4`) — ✅ `@v0.8.0` / `@v0.9.0` / `@v0.10.0` / `@v0.11.0` / `@v0.12.0` / `@v0.13.0` / `@v0.14.0` / `@v0.15.0` ([114](114-machine-esp-esp32-p4.md); ADC2 ✅; LP GPIO ✅; regi2c ✅; LP UART ✅)  
...
9. **Ethernet** — ✅ [`esp_eth`](https://github.com/klin-lang/esp_eth) `@v0.2.0` (W5500 + RMII; not in `machine_esp`) → [102](102-esp-eth-idf.md)  
...
13. No DAC / no PIO API; P4 eFuse-cal / freestanding / classic ESP32 / C6 later ([062](062-targets-esp-rp.md); RMII ✅ [102](102-esp-eth-idf.md) `@v0.2.0`)  
...
5. **ATmega32U4 (Leonardo / Micro / Pro Micro)** — ✅ `@v0.3.0` → [142](142-machine-avr-atmega32u4.md) (`*_32u4`)  

**`machine_tinyavr`** (new package — not `machine_avr`)

1. **ATtiny1624** Pin…Adc MVP — planned → [141](141-machine-tinyavr.md)  
2. Other tinyAVR 0/1/2 parts / AVR Dx twins — after 1624  
...
- `network` — Wi‑Fi/Ethernet (ESP etc.) — Klin: [`esp_wifi`](https://github.com/klin-lang/esp_wifi) STA → [101](101-esp-wifi-idf.md); [`esp_eth`](https://github.com/klin-lang/esp_eth) W5500 + RMII → [102](102-esp-eth-idf.md)  
- `bluetooth` — Klin: [`esp_ble`](https://github.com/klin-lang/esp_ble) NimBLE GATT + bond + UUID16/128 + privacy + Mesh OnOff → [106](106-esp-ble-idf.md)  
- `USBDevice` / USB CDC (ESP OTG) — Klin: [`esp_usb`](https://github.com/klin-lang/esp_usb) TinyUSB device CDC → [108](108-esp-usb-idf.md)  
- `esp.camera` / DVP JPEG — Klin: [`esp_camera`](https://github.com/klin-lang/esp_camera) → [109](109-esp-camera-idf.md)  
