...
9. **BLE** — ✅ [`esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.5.0` (advertise + GATT server/client + scan/connect + Just Works bond; not in `machine_esp`) → [106](106-esp-ble-idf.md)  
...
- `bluetooth` — Klin: [`esp_ble`](https://github.com/klin-lang/esp_ble) NimBLE advertise + GATT server/client + scan + bond → [106](106-esp-ble-idf.md)  
