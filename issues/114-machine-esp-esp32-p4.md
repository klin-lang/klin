# 114 — `machine_esp` ESP32-P4 (Pin…Spi+Rmt twin factories)

**Status:** ✅ published [`@v0.8.0`](https://github.com/klin-lang/machine_esp/releases/tag/v0.8.0) (Pin) / [`@v0.9.0`](https://github.com/klin-lang/machine_esp/releases/tag/v0.9.0) (Pwm…Spi) / [`@v0.10.0`](https://github.com/klin-lang/machine_esp/releases/tag/v0.10.0) (Rmt TX)  
...
| P4 | Explicit: `pin_out_p4` / `pin_in_p4` / `pwm_out_p4` / `rc_out_p4` / `uart_out_p4` / `i2c_out_p4` / `spi_out_p4` / `rmt_tx_p4` |
...
1. **Bases** — GPIO `0x500E0000`, IO_MUX `0x500E1000`; LEDC `0x500D3000`; UART0 `0x500CA000` + n×`0x1000`; I2C0 `0x500C4000`; SPI2 `0x500D0000`; RMT `0x500A2000`  
...
7. **Signals** — UART0..4 TX/RX **10/13/16/19/22**; LEDC_LS_SIG_OUT0..7 **126..133**; I2C0 SCL/SDA **68/69**; SPI2 CK/Q/D **53/54/55**; RMT_SIG_OUT0..3 **246..249**  
...
- Adc `*_p4` — later (P4 oneshot is **LP_ADC**, not HP `0x500DE000` SARADC)  
- LP GPIO  
...
- PR: https://github.com/klin-lang/machine_esp/pull/8 (Pin), [#9](https://github.com/klin-lang/machine_esp/pull/9) (Pwm…Spi), [#10](https://github.com/klin-lang/machine_esp/pull/10) (Rmt)  
- Tags: [v0.8.0](https://github.com/klin-lang/machine_esp/releases/tag/v0.8.0), [v0.9.0](https://github.com/klin-lang/machine_esp/releases/tag/v0.9.0), [v0.10.0](https://github.com/klin-lang/machine_esp/releases/tag/v0.10.0)  
