...
| P4 | Explicit: `pin_out_p4` / `pin_in_p4` / `pin_out_lp_p4` / `pin_in_lp_p4` / `pwm_out_p4` / `rc_out_p4` / `uart_out_p4` / `i2c_out_p4` / `spi_out_p4` / `rmt_tx_p4` / `adc_out_p4` / `adc2_out_p4` |
...
1. **Bases** — GPIO `0x500E0000`, IO_MUX `0x500E1000`; LEDC `0x500D3000`; UART0 `0x500CA000` + n×`0x1000`; I2C0 `0x500C4000`; SPI2 `0x500D0000`; RMT `0x500A2000`; LP_ADC `0x50127000`; LP_GPIO `0x5012A000`; LP_IOMUX `0x5012B000`  
...
- PR: https://github.com/klin-lang/machine_esp/pull/8 (Pin), [#9](https://github.com/klin-lang/machine_esp/pull/9) (Pwm…Spi), [#10](https://github.com/klin-lang/machine_esp/pull/10) (Rmt), [#11](https://github.com/klin-lang/machine_esp/pull/11) (Adc1), [#12](https://github.com/klin-lang/machine_esp/pull/12) (Adc2), [#13](https://github.com/klin-lang/machine_esp/pull/13) (LP GPIO)  
