# 135 — `machine_gd32v`: GD32VF103 (Nuclei RISC-V) Pin…Adc

**Status:** ✅ MVP `@v0.2.0` published (Pin…Adc + freestanding examples)  
**Depends on:** [061](061-micropython-machine-api.md), [062](062-targets-esp-rp.md), [134](134-machine-ch32v.md)
**Formerly:** `087` (renumbered to resolve duplicate issue numbers).
...
| vs CH32V | Separate repo ([134](134-machine-ch32v.md)) — QingKe vs Nuclei |
...
- Wi‑Fi on VW553 — [137](137-gd32v-wifi-sdk.md) / [`gd32v_wifi`](https://github.com/klin-lang/gd32v_wifi) [`@v0.4.0`](https://github.com/klin-lang/gd32v_wifi/releases/tag/v0.4.0) (not this file)  
...
- BLE on VW553 — [140](140-gd32v-ble-sdk.md) / [`gd32v_ble`](https://github.com/klin-lang/gd32v_ble) [`@v0.13.0`](https://github.com/klin-lang/gd32v_ble/releases/tag/v0.13.0) (not this file)

## Links

- Package: https://github.com/klin-lang/machine_gd32v  
- CH32V port: [134](134-machine-ch32v.md)  
