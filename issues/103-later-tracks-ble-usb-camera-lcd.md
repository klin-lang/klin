...
| BLE peripheral + central + GATT + bond + UUID16/128 + multi-svc + passkey (IDF NimBLE) | [`esp_ble`](https://github.com/klin-lang/esp_ble) → [106](106-esp-ble-idf.md) ✅ `@v0.8.0` (privacy / mesh later on that package) |
...
|---|---|---|---|
| A | **BLE** | ✅ shipped → [106](106-esp-ble-idf.md) / [`esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.8.0` | Advertise + GATT server/client + scan/connect + bond + UUID16/128 + multi-svc + passkey done; privacy / mesh stay on that package (not here). |
