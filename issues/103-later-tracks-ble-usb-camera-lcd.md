...
| BLE peripheral + central + GATT client + bond (IDF NimBLE) | [`esp_ble`](https://github.com/klin-lang/esp_ble) → [106](106-esp-ble-idf.md) ✅ `@v0.5.0` (custom UUIDs / passkey / mesh later on that package) |
...
|---|---|---|---|
| A | **BLE** | ✅ shipped → [106](106-esp-ble-idf.md) / [`esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.5.0` | Advertise + GATT server/client + scan/connect + Just Works bond done; custom UUID tables / passkey / mesh stay on that package (not here). |
