...
| BLE peripheral + central + GATT + bond + UUID16 (IDF NimBLE) | [`esp_ble`](https://github.com/klin-lang/esp_ble) → [106](106-esp-ble-idf.md) ✅ `@v0.6.0` (128-bit tables / passkey / mesh later on that package) |
...
|---|---|---|---|
| A | **BLE** | ✅ shipped → [106](106-esp-ble-idf.md) / [`esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.6.0` | Advertise + GATT server/client + scan/connect + Just Works bond + UUID16 done; 128-bit tables / passkey / mesh stay on that package (not here). |
