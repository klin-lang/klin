...
| **GD32VW553** | ✅ Pin…Adc | Same package [`@v0.8.0`](https://github.com/klin-lang/machine_gd32v/releases/tag/v0.8.0) — `pin_out_vw553` / `pwm_out_vw553` / `rc_out_vw553` / `uart_out_vw553` / `i2c_out_vw553` / `spi_out_vw553` / `adc_out_vw553` ([117](117-machine-gd32v-gd32vw553.md)); Nuclei N307; F4-style GPIO `0x40020000` + AFSEL (**not** VF103 `0x40010800` / AFIO); USART/I2C/ADC new-style; SPI same CTL0/STAT/DATA as VF103. Wi‑Fi 6 / BLE later. |
...
12b. **GD32VW553** Pin…Adc twins — ✅ `pin_out_vw553` / `pwm_out_vw553` / `rc_out_vw553` / `uart_out_vw553` / `i2c_out_vw553` / `spi_out_vw553` / `adc_out_vw553` `machine_gd32v@v0.8.0` ([117](117-machine-gd32v-gd32vw553.md); radio later)  
