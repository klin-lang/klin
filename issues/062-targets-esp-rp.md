...
15. **BLE** (ESP-IDF NimBLE advertise + GATT + scan/connect + client + bond + UUID16/128 + multi-svc + passkey + privacy/RPA) — ✅ [`esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.9.0` ([106](106-esp-ble-idf.md); mesh later; not in `machine_*`)  
