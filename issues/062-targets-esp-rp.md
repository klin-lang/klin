...
15. **BLE** (ESP-IDF NimBLE advertise + GATT MVP) — ✅ [`esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.2.0` ([106](106-esp-ble-idf.md); central / bonding later; not in `machine_*`)  
