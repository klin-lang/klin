...
| **GD32VW553** | ✅ Pin…Adc; 🔨 Wi‑Fi STA+SoftAP+scan+link+static+APSTA+roaming; 🔨 BLE advertise+GATT+scan/connect+gattc+jw-bond+uuid16+passkey+uuid128/multi+privacy+mesh+prov+level+friend+oob; 🔨 sockets; 🔨 HTTP/TLS PEM | Same package [`@v0.8.0`](https://github.com/klin-lang/machine_gd32v/releases/tag/v0.8.0) — `pin_out_vw553`…`adc_out_vw553` ([136](136-machine-gd32v-gd32vw553.md)); boards [`gd32vw553h_eval`](https://github.com/klin-lang/gd32vw553h_eval) [`@v0.1.0`](https://github.com/klin-lang/gd32vw553h_eval/releases/tag/v0.1.0) [138](138-board-gd32vw553h-eval.md), [`gd32vw553h_start`](https://github.com/klin-lang/gd32vw553h_start) [`@v0.1.0`](https://github.com/klin-lang/gd32vw553h_start/releases/tag/v0.1.0) [139](139-board-gd32vw553h-start.md); Wi‑Fi → [`gd32v_wifi`](https://github.com/klin-lang/gd32v_wifi) [`@v0.6.0`](https://github.com/klin-lang/gd32v_wifi/releases/tag/v0.6.0) [137](137-gd32v-wifi-sdk.md) (GigaDevice `wifi_management`, **not** ESP-IDF). BLE → [`gd32v_ble`](https://github.com/klin-lang/gd32v_ble) [`@v0.14.0`](https://github.com/klin-lang/gd32v_ble/releases/tag/v0.14.0) [140](140-gd32v-ble-sdk.md) (AN152, **not** NimBLE). Sockets → [`gd32v_sockets`](https://github.com/klin-lang/gd32v_sockets) `@v0.1.0` [143](143-gd32v-sockets-sdk.md); HTTP → [`gd32v_http`](https://github.com/klin-lang/gd32v_http) `@v0.1.0` [144](144-gd32v-http-sdk.md) (after IP; **not** `esp_sockets` / `esp_http`). Nuclei N307; F4-style GPIO. |
...
12c. **GD32VW553 Wi‑Fi** STA + SoftAP + scan + link + static + APSTA + roaming — 🔨 [`gd32v_wifi`](https://github.com/klin-lang/gd32v_wifi) `@v0.6.0` ([137](137-gd32v-wifi-sdk.md); GigaDevice SDK, not `esp_wifi`)  
...
12f. **GD32VW553 BLE** advertise + GATT + central + gattc + jw-bond + UUID16 + passkey + UUID128/multi + privacy + Mesh OnOff + provisioner + Level/vendor + Friend/LPN + interactive OOB — 🔨 [`gd32v_ble`](https://github.com/klin-lang/gd32v_ble) `@v0.14.0` ([140](140-gd32v-ble-sdk.md); GigaDevice AN152, not `esp_ble`)  
