...
|---|---|---|
| **RP2040** | ✅ path exists | [`machine_rp`](https://github.com/klin-lang/machine_rp) `@v0.7.0` — Pin+Pwm+Rc+Uart+I2c+Spi+Adc+**Pio** (no DAC). |
...
6. **Pio** on RP — ✅ (`machine_rp@v0.7.0`; not on other MCU families)  
