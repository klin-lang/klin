...
15. **BLE** (ESP-IDF NimBLE GATT + scan/client + bond + UUID16 + passkey) — ✅ [`esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.7.0` ([106](106-esp-ble-idf.md); 128-bit tables / privacy / mesh later; not in `machine_*`)  
