...
| **GD32VW553** | 🔨 Pin twins | Same package — `pin_out_vw553` / `pin_in_vw553` ([117](117-machine-gd32v-gd32vw553.md)); Nuclei N307; F4-style GPIO `0x40020000` (**not** VF103 `0x40010800`). Wi‑Fi 6 / BLE later, not `machine_*`. |
...
12b. **GD32VW553** Pin twins — 🔨 `pin_out_vw553` ([117](117-machine-gd32v-gd32vw553.md); same `machine_gd32v`; Pwm…Adc / radio later)  
