...
**Status:** 🚧 — RP / ESP / STM8 / CH32V / GD32V via external `machine_*` (Pin…Adc); Wi‑Fi [`esp_wifi`](https://github.com/klin-lang/esp_wifi) ✅; ETH [`esp_eth`](https://github.com/klin-lang/esp_eth) ✅ (W5500); BLE [`esp_ble`](https://github.com/klin-lang/esp_ble) ✅; USB OTG [`esp_usb`](https://github.com/klin-lang/esp_usb) ✅ (device CDC); camera [`esp_camera`](https://github.com/klin-lang/esp_camera) ✅ (DVP JPEG); **ESP32-P4 Pin…Adc+Rmt** ✅ [`@v0.11.0`](https://github.com/klin-lang/machine_esp/releases/tag/v0.11.0) ([114](114-machine-esp-esp32-p4.md)); ADC2 / RMII / classic / freestanding later
...
| **ESP32-P4** | ✅ Pin…Adc+Rmt (`*_p4`) | Same package [`@v0.11.0`](https://github.com/klin-lang/machine_esp/releases/tag/v0.11.0) — `pin_out_p4`…`spi_out_p4` + `rmt_tx_p4` + `adc_out_p4` ([114](114-machine-esp-esp32-p4.md)); MMIO `0x500E…` / RMT `0x500A2000` / LP_ADC `0x50127000` / HP_SYS_CLKRST (**not** a copy of C3/S3 `0x6000…`); LEDC **`freq_p4`**; ADC **`read_u12_p4`** (CH0→GPIO16); HP GPIO 0..54; **no** on-die Wi‑Fi/BLE (companion / other host). ADC2 later. **On-chip EMAC** (RMII) → next [`esp_eth`](https://github.com/klin-lang/esp_eth) backend [102](102-esp-eth-idf.md) / [104](104-later-tracks-esp-network.md) E1. |
...
- Classic Xtensa ESP32 / C6 ports (S3 Pin…Adc ✅ → [099](099-machine-esp-esp32-s3.md); P4 Pin…Adc+Rmt ✅ → [114](114-machine-esp-esp32-p4.md); P4 ADC2 / RMII via [102](102-esp-eth-idf.md) later)
