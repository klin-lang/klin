...
**Status:** 🚧 — RP / ESP / STM8 / CH32V / GD32V via external `machine_*` (Pin…Adc); Wi‑Fi [`esp_wifi`](https://github.com/klin-lang/esp_wifi) ✅; ETH [`esp_eth`](https://github.com/klin-lang/esp_eth) ✅ (W5500); BLE [`esp_ble`](https://github.com/klin-lang/esp_ble) ✅; USB OTG [`esp_usb`](https://github.com/klin-lang/esp_usb) ✅ (device CDC); camera [`esp_camera`](https://github.com/klin-lang/esp_camera) ✅ (DVP JPEG); **ESP32-P4** / classic / freestanding later
...
21. **Later network** (RMII / dual Wi‑Fi+ETH…) — 🔨 Wi‑Fi W1–W3 + sockets + HTTP/TLS ✅ [`esp_http`](https://github.com/klin-lang/esp_http) [112](112-esp-http-idf.md); ETH rest 💭 [104](104-later-tracks-esp-network.md)  
