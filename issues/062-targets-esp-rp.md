...
12f. **GD32VW553 BLE** advertise + GATT + central + gattc + jw-bond + UUID16 + passkey + UUID128/multi + privacy — 🔨 [`gd32v_ble`](https://github.com/klin-lang/gd32v_ble) `@v0.9.0` ([140](140-gd32v-ble-sdk.md); GigaDevice AN152, not `esp_ble`; mesh later)  
