...
12g. **GD32VW553 sockets** TCP/UDP LwIP BSD — 🔨 [`gd32v_sockets`](https://github.com/klin-lang/gd32v_sockets) `@v0.1.0` ([143](143-gd32v-sockets-sdk.md); after `gd32v_wifi` IP; not `esp_sockets`)  
12h. **GD32VW553 HTTP(+TLS PEM)** — 🔨 [`gd32v_http`](https://github.com/klin-lang/gd32v_http) `@v0.1.0` ([144](144-gd32v-http-sdk.md); caller PEM only, no IDF crt bundle; not `esp_http`)  
