...
12c. **GD32VW553 Wi‑Fi** STA + SoftAP + scan + link + static — 🔨 [`gd32v_wifi`](https://github.com/klin-lang/gd32v_wifi) `@v0.4.0` ([126](126-gd32v-wifi-sdk.md); GigaDevice SDK, not `esp_wifi`; APSTA/BLE later)  
