...
| **GD32VW553** | 🔨 Pin+Pwm+Rc+Uart+I2c+Spi ✅ | Same package [`@v0.7.0`](https://github.com/klin-lang/machine_gd32v/releases/tag/v0.7.0) — `pin_out_vw553` / `pwm_out_vw553` / `rc_out_vw553` / `uart_out_vw553` / `i2c_out_vw553` / `spi_out_vw553` ([117](117-machine-gd32v-gd32vw553.md)); Nuclei N307; F4-style GPIO `0x40020000` + AFSEL (**not** VF103 `0x40010800` / AFIO); USART/I2C new-style; SPI same CTL0/STAT/DATA as VF103. Adc / Wi‑Fi 6 / BLE later. |
...
12b. **GD32VW553** Pin+Pwm+Rc+Uart+I2c+Spi twins — ✅ `pin_out_vw553` / `pwm_out_vw553` / `rc_out_vw553` / `uart_out_vw553` / `i2c_out_vw553` / `spi_out_vw553` `machine_gd32v@v0.7.0` ([117](117-machine-gd32v-gd32vw553.md); Adc / radio later)  
