...
| **GD32VW553** | ✅ Pin…Adc; 🔨 Wi‑Fi STA+SoftAP+scan+link+static; 🔨 BLE advertise+GATT+scan/connect+gattc+jw-bond | Same package [`@v0.8.0`](https://github.com/klin-lang/machine_gd32v/releases/tag/v0.8.0) — `pin_out_vw553`…`adc_out_vw553` ([117](117-machine-gd32v-gd32vw553.md)); boards [`gd32vw553h_eval`](https://github.com/klin-lang/gd32vw553h_eval) [`@v0.1.0`](https://github.com/klin-lang/gd32vw553h_eval/releases/tag/v0.1.0) [127](127-board-gd32vw553h-eval.md), [`gd32vw553h_start`](https://github.com/klin-lang/gd32vw553h_start) [`@v0.1.0`](https://github.com/klin-lang/gd32vw553h_start/releases/tag/v0.1.0) [129](129-board-gd32vw553h-start.md); Wi‑Fi → [`gd32v_wifi`](https://github.com/klin-lang/gd32v_wifi) [`@v0.4.0`](https://github.com/klin-lang/gd32v_wifi/releases/tag/v0.4.0) [126](126-gd32v-wifi-sdk.md) (GigaDevice `wifi_management`, **not** ESP-IDF). BLE → [`gd32v_ble`](https://github.com/klin-lang/gd32v_ble) [`@v0.5.0`](https://github.com/klin-lang/gd32v_ble/releases/tag/v0.5.0) [130](130-gd32v-ble-sdk.md) (AN152, **not** NimBLE). Nuclei N307; F4-style GPIO. |
...
12c. **GD32VW553 Wi‑Fi** STA + SoftAP + scan + link + static — 🔨 [`gd32v_wifi`](https://github.com/klin-lang/gd32v_wifi) `@v0.4.0` ([126](126-gd32v-wifi-sdk.md); GigaDevice SDK, not `esp_wifi`; APSTA later)  
12d. **GD32VW553H-EVAL** board pack — 🔨 [`gd32vw553h_eval`](https://github.com/klin-lang/gd32vw553h_eval) `@v0.1.0` ([127](127-board-gd32vw553h-eval.md); `klin init gd32vw553h-eval`)  
12e. **GD32VW553 START** board pack — 🔨 [`gd32vw553h_start`](https://github.com/klin-lang/gd32vw553h_start) `@v0.1.0` ([129](129-board-gd32vw553h-start.md); `klin init gd32vw553h-start`; UART2 PA6/PA7)  
12f. **GD32VW553 BLE** advertise + GATT + central + gattc + Just Works bond — 🔨 [`gd32v_ble`](https://github.com/klin-lang/gd32v_ble) `@v0.5.0` ([130](130-gd32v-ble-sdk.md); GigaDevice AN152, not `esp_ble`; passkey/UUID later)  
...
- GD32V package: https://github.com/klin-lang/machine_gd32v ([087](087-machine-gd32v.md); VW553 [117](117-machine-gd32v-gd32vw553.md))  
