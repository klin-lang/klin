...
15. **BLE** (ESP-IDF NimBLE advertise + GATT + scan/connect + client) — ✅ [`esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.4.0` ([106](106-esp-ble-idf.md); bonding / custom UUIDs later; not in `machine_*`)  
