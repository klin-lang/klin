...
15. **BLE** (ESP-IDF NimBLE advertise + GATT + scan/connect) — ✅ [`esp_ble`](https://github.com/klin-lang/esp_ble) `@v0.3.0` ([106](106-esp-ble-idf.md); GATT client / bonding later; not in `machine_*`)  
